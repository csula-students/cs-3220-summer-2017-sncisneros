...
public void init() {
		...
		custItems.add(new FoodItem(custItems.size(), "Hamburger", "http://toriavey.com/images/2013/08/Hamburger-History-1.jpg", "An all-American burger, made medium-well, with a whole wheat bun. Unlimited fries included!", 12.99));
		getServletContext().setAttribute("custItems", custItems);
	
		custItems1.add(new FoodItem(custItems.size(), "Hamburger", "http://toriavey.com/images/2013/08/Hamburger-History-1.jpg", "An all-American burger, made medium-well, with a whole wheat bun. Unlimited fries included!", 12.99));
		custItems1.add(new FoodItem(custItems.size(), "Buffalo Wings", "http://fodmapliving.com/wp-content/uploads/2013/01/buffalo-wings.jpg", "Ten chicken wings soaked in a spicy buffalo sauce. Served with ranch.", 15.95));
		...
		*/
		...
		for (Order order: orders){
			...
			out.println("<tr align='center'>" +
					...
					"<td>" + order.getStatuses() + "<br /><a href='../admin/orders/edit?id=" + order.getId() + "'>Update Status</a> " +
					"</tr>");
		}
		out.println("</table>");
